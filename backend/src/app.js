...
const vatInfoRoutes = require('./routes/vatInfo')
...
const dailyEcommerceReportRoutes = require('./routes/dailyEcommerceReport.routes')
const ecommerceReportsRoutes = require('./routes/ecommerceReports.routes')
...
const amazonInitialDraftRoutes = require('./routes/amazonInitialDraft.routes')
const listingBatchesRoutes = require('./routes/listingBatches.routes')
const inventoryRoutes = require('./routes/inventory.routes')
const noonRoutes = require('./routes/noonRoutes')
const noonPaymentClearingRoutes = require('./routes/noonPaymentClearing.routes')
...
app.use('/api/reports', authMiddleware.attachAuth, dailyEcommerceReportRoutes)
app.use('/api/reports', authMiddleware.attachAuth, ecommerceReportsRoutes)
...
app.use('/api/amazon-initial-draft', authMiddleware.attachAuth, amazonInitialDraftRoutes)
...
app.use('/api/iso-qms', authMiddleware.attachAuth, isoQmsRoutes)
