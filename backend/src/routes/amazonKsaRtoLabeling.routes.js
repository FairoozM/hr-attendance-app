...
router.post('/batches/:id/share', ctrl.postShare)
router.patch('/batches/:id/share', ctrl.patchShare)
router.delete('/batches/:id/share', ctrl.deleteShare)
router.post('/batches/:id/reopen-agent', ctrl.postReopenAgent)
