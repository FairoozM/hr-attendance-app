...
router.get('/jobs/:jobId', ctrl.getClearingJob)
router.get('/posting-jobs/:jobId', ctrl.getPostingJob)
router.get('/preview-upload/jobs/:jobId', ctrl.getClearingJob)
router.post('/batches/:id/approve', ctrl.postApproveBatch)
router.post('/batches/:id/reconcile-open-balances', ctrl.postReconcileOpenBalances)
router.post('/batches/:id/exclude-open-balance-shortfalls', ctrl.postExcludeOpenBalanceShortfalls)
router.post('/batches/:id/payment-preview', ctrl.postPaymentPreview)
router.get('/batches/:id/credit-note-apply-plan', ctrl.getCreditNoteApplyPlan)
router.post('/batches/:id/apply-credit-notes', ctrl.postApplyCreditNotes)
router.get('/batches/:id/return-fee-plan', ctrl.getReturnFeePlan)
router.post('/batches/:id/post-return-fee-journals', ctrl.postReturnFeeJournals)
router.post('/batches/:id/reset-return-fee-journals', ctrl.postResetReturnFeeJournals)
router.post('/batches/:id/refresh-return-matching', ctrl.postRefreshReturnMatching)
