...
export const EMPTY_RANK_MAP: Map<string, InfluencerContractRanking> = new Map()

export function influencerInitials(name: string | null | undefined): string {
...
export function useMetricBests(
  records: Array<Pick<InfluencerContractRow, 'views' | 'likes' | 'comments' | 'shares' | 'salesAed' | 'cost' | 'netProfitAed'>>,
  includeNetProfit: boolean,
): InfluencerMetricBests | null {
  return useMemo(() => {
    ...
    const base: InfluencerMetricBests = {
...
export const WINNER_TITLE: Record<InfluencerMetricBestField, string> = {
...
export function winnerPillMod(
  field: InfluencerMetricBestField,
  record: Partial<InfluencerContractRow>,
