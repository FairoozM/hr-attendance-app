          ...
          >
            ...
            {metricConfig.map(({ label, key, Icon }) => (
              <div key={key} className="ip-hud-metric-row">
                <span><Icon size={18} /><span className="ip-hud-metric-label-text">{label}</span></span>
                {!inWindow ? (
            ...
            <div className="ip-hud-metric-row">
              <span><GalleryHorizontal size={18} /><span className="ip-hud-metric-label-text">Story</span></span>
              {!inWindow ? (
