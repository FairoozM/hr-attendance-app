  ...
  return (
    <div className="abw-page">
      <header className="abw-header">
        <div className="abw-header__copy">
          ...
          <p className="abw-subtitle">
            Monitor key Zoho Books balances — banks, cash, clearing, VAT, and control accounts —
            in one shared company watchlist.
          </p>
        </div>
      ...
      {refreshedAt && !loading && !error && accounts.length > 0 ? (
        <p className="abw-meta">Last refreshed {formatRefreshedAt(refreshedAt)}</p>
      ) : null}
          ...
          <table className="abw-table">
            <thead>
              <tr>
                ...
                <th className="abw-num">Closing balance</th>
                <th>Refreshed</th>
            ...
            <tbody>
              {accounts.map((account) => (
                <tr key={account.accountId}>
                  ...
                  <td className="abw-num abw-balance">
                    {formatMoney(account.closingBalance, account.currencyCode)}
                  </td>
                  <td className="abw-muted">{formatRefreshedAt(account.refreshedAt || refreshedAt)}</td>
